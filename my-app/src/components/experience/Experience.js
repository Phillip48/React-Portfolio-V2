        ...
        <section className='holds-experience-section' id='experience'>
            ...
            <div className='holds-experience-sides'>
                <section className='section-left-experience'>
                    <div className='margin-side one-project'>
                        <a href='https://github.com/Phillip48/country-V2'><img src={travelGuide} alt='project-img' className='experience-img'></img>
                        <h3 className='sub-intro-med padding-top'>🌎 Tarvelers Guide <button className='linktosite'>Check it out!</button></h3> 
                    ...
                    <div className='margin-side one-project'>
                        ...
                        <h3 className='sub-intro-med padding-top'>🍿 Reel Good Movies <button className='linktosite'>Check it out!</button></h3>
                ...
                <section className='section-right-experience'>
                    <div className='margin-side one-project'>
                        ...
                        <h3 className='sub-intro-med padding-top'>🛣️ Route My Day <button className='linktosite'>Check it out!</button></h3>
